...
<p align="center" >
  <kbd>
    <img
      src="https://github.com/hassanprodeveloper/hpd-react-native-fast-image/blob/main/docs/assets/scroll.gif?raw=true"
      title="Scroll Demo"
      float="left"
    >
  </kbd>
  <kbd>
    <img
      src="https://github.com/hassanprodeveloper/hpd-react-native-fast-image/blob/main/docs/assets/priority.gif?raw=true"
      title="Priority Demo"
      float="left"
    >
  </kbd>
...
**Note: You must be using React Native 0.60.0 or higher to use the most recent version of `hpd-react-native-fast-image`.**

```bash
yarn add hpd-react-native-fast-image
cd ios && pod install
```

```jsx
import FastImage from 'hpd-react-native-fast-image'
...
-   FastImage - MIT © [hassanprodeveloper](https://github.com/hassanprodeveloper)
-   SDWebImage - `MIT`
-   Glide - BSD, part MIT and Apache 2.0. See the [LICENSE](https://github.com/bumptech/glide/blob/master/license) file for details.

[build-badge]: https://github.com/dylanvann/hpd-react-native-fast-image/workflows/CI/badge.svg
[build]: https://github.com/hassanprodeveloper/hpd-react-native-fast-image/actions?query=workflow%3ACI
[coverage-badge]: https://img.shields.io/codecov/c/github/dylanvann/hpd-react-native-fast-image.svg
[coverage]: https://codecov.io/github/dylanvann/hpd-react-native-fast-image
[downloads-badge]: https://img.shields.io/npm/dm/hpd-react-native-fast-image.svg
[npmtrends]: http://www.npmtrends.com/hpd-react-native-fast-image
[package]: https://www.npmjs.com/package/hpd-react-native-fast-image
[version-badge]: https://img.shields.io/npm/v/hpd-react-native-fast-image.svg
[twitter]: https://twitter.com/home?status=Check%20out%20react-native-fast-image%20by%20%40atomarranger%20https%3A//github.com/hassanprodeveloper/hpd-react-native-fast-image
[twitter-badge]: https://img.shields.io/twitter/url/https/github.com/hassanprodeveloper/hpd-react-native-fast-image.svg?style=social
[github-watch-badge]: https://img.shields.io/github/watchers/dylanvann/hpd-react-native-fast-image.svg?style=social
[github-watch]: https://github.com/dylanvann/hpd-react-native-fast-image/watchers
[github-star-badge]: https://img.shields.io/github/stars/dylanvann/hpd-react-native-fast-image.svg?style=social
[github-star]: https://github.com/dylanvann/hpd-react-native-fast-image/stargazers
